...
idk1.Text = "but it refused(broke)"
idk1.TextColor3 = Color3.fromRGB(0, 0, 0)
idk1.TextSize = 20.000
idk1.MouseButton1Down:connect(function()
 loadstring(game:HttpGet("https://raw.githubusercontent.com/ReduxRBLX/But-it-refused/refs/heads/main/Script"))()
end)
...
idk2.Text = "gojo move[upd] "
idk2.TextColor3 = Color3.fromRGB(0, 0, 0)
idk2.TextSize = 20.00
idk2.MouseButton1Down:connect(function()
 loadstring(game:HttpGet('https://pastebin.com/raw/fECkhypx'))()
end)
...
idk3.MouseButton1Down:connect(function()
 loadstring(game:HttpGet("https://rawscripts.net/raw/The-Strongest-Battlegrounds-FLOATING-GIRL-22954"))()
end)
...
close.Parent = Frame
close.BackgroundColor3 = Color3.fromRGB(215, 142, 125)
